...
*   **[Kubernetes Application Recommended Path](docs/kubernetes-application-recommended-path.md)**: Create an application in Backstage, add source code, and deploy it to EKS.
